...
//{
//    public class VideoService(IBaseRepository<Share> repository) : BaseService<Share>(repository), IShareService
//    {
//        /// <summary>
//        /// 获取文章列表列表数据分页
//        /// </summary>
...
//        public async Task<ApiResult<PageData<Share>>> GetShareListPageAsync(bool? publishedStatus, int pageIndex = 1, int pageSize = 10)
//        {
//            //基于 efcore 通过条件检索
//            IQueryable<Share> query = _repository.Query()
//                .WhereIf(e => e.publishedStatus == publishedStatus, publishedStatus != null);
//            //获取文章数量
